...
import FIELD_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Segment__c.CQ_FLEX_Scouting_Segment_Support__c';

import FIELD_CQ_FLEX_SCOUTING_COMMENTS__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Segment__c.CQ_FLEX_Scouting_Comments__c';
...
const fields = [
    ...
    FIELD_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C,
    
    FIELD_CQ_FLEX_SCOUTING_COMMENTS__C,
...
export default class cquiFlexFlexSupplierSegmentScoutingBoth  extends cqRecordForm {
    ...
    get v_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C() {
        return this.getValueFor(FIELD_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C.fieldApiName);
    }
    get f_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C() {
        return lookupDisplayFields[FIELD_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C.fieldApiName].fieldApiName);
    }

    
    get v_CQ_FLEX_SCOUTING_COMMENTS__C() {
        return this.getValueFor(FIELD_CQ_FLEX_SCOUTING_COMMENTS__C.fieldApiName);
    }
    get f_CQ_FLEX_SCOUTING_COMMENTS__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_FLEX_SCOUTING_COMMENTS__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_FLEX_SCOUTING_COMMENTS__C() {
        return lookupDisplayFields[FIELD_CQ_FLEX_SCOUTING_COMMENTS__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_FLEX_SCOUTING_COMMENTS__C.fieldApiName].fieldApiName);
    }
