...
import CQFLEX_SUPPLIER_DOCUMENT_FOR_PARENT_ACCOUNT from '@salesforce/label/c.CQFLEX_SUPPLIER_DOCUMENT_FOR_PARENT_ACCOUNT';
...
export default class cquiFlexCertificationParentSupDocGrid  extends CqGridForm {
    @api
    maxRows;
    ...
    constructor() {
        ...
        this.customTitle = CQFLEX_SUPPLIER_DOCUMENT_FOR_PARENT_ACCOUNT;
        ...
        this.componentName="c:cquiFlexCertificationParentSupDocGrid";
