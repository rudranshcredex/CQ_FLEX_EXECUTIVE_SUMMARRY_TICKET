...
import OBJECT_CQ_FLEX_SQX_SUPPLIER_REGION__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c';


// Field_<field api name without __c if present>

import FIELD_CQ_FLEX_SQX_ACCOUNT__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c.CQ_FLEX_SQX_Account__c';

import FIELD_NAME from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c.Name';

import FIELD_CQ_FLEX_REGION__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c.CQ_FLEX_Region__c';

import FIELD_CQ_FLEX_YES_NO__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c.CQ_FLEX_Yes_No__c';

import FIELD_CREATEDBYID from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c.CreatedById';

import FIELD_LASTMODIFIEDBYID from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c.LastModifiedById';
...
import FIELD_CQ_FLEX_SQX_ACCOUNT__NAME from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Region__c.CQ_FLEX_SQX_Account__r.Name';
...
const fields = [
    ...
    FIELD_CQ_FLEX_REGION__C,
    
    FIELD_CQ_FLEX_YES_NO__C,
...
const FORM_RULES = {"CQ_FLEX_SQX_Account__c":{"readonly":{"fields":["CQ_FLEX_SQX_Account__c"],"filter":"record.CQ_FLEX_SQX_Account__c   "}},"Name":{"readonly":{"fields":["Name"],"filter":"record.Name   "},"hidden":{"fields":["Name"],"filter":"!record.Name   "}}};
const FORMULA_FIELDS = {};

export default class cquiFlexFlexSupplierRegionBoth  extends cqRecordForm {
    ...
    constructor() {
        super();
        this.init(OBJECT_CQ_FLEX_SQX_SUPPLIER_REGION__C,fields,lookupDisplayFields);
    ...
    get v_CQ_FLEX_REGION__C() {
        return this.getValueFor(FIELD_CQ_FLEX_REGION__C.fieldApiName);
    }
    get f_CQ_FLEX_REGION__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_FLEX_REGION__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_FLEX_REGION__C() {
        return lookupDisplayFields[FIELD_CQ_FLEX_REGION__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_FLEX_REGION__C.fieldApiName].fieldApiName);
    }

    
    get v_CQ_FLEX_YES_NO__C() {
        return this.getValueFor(FIELD_CQ_FLEX_YES_NO__C.fieldApiName);
    }
    get f_CQ_FLEX_YES_NO__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_CQ_FLEX_YES_NO__C.fieldApiName] : {};
        return val;
    }

    get d_CQ_FLEX_YES_NO__C() {
        return lookupDisplayFields[FIELD_CQ_FLEX_YES_NO__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_CQ_FLEX_YES_NO__C.fieldApiName].fieldApiName);
    }
