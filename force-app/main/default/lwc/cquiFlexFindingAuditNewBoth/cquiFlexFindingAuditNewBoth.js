...
import FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C from '@salesforce/schema/compliancequest__SQX_Finding__c.compliancequest__SQX_Regulatory_Requirement__c';
...
import FIELD_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C from '@salesforce/schema/compliancequest__SQX_Finding__c.compliancequest__Track_External_Response__c';
...
import FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__NAME from '@salesforce/schema/compliancequest__SQX_Finding__c.compliancequest__SQX_Regulatory_Requirement__r.Name';
...
const fields = [
    ...
    FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C,
    ...
    FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__NAME,
...
const lookupDisplayFields = {
    ...
    "compliancequest__SQX_Regulatory_Requirement__c": FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__NAME,
...
const FORM_RULES = {"compliancequest__Track_External_Response__c":{"required":{"fields":["compliancequest__Finding_Type__c","compliancequest__CAPA_Required__c"],"filter":"(record.compliancequest__Finding_Type__c == 'Critical'  && record.compliancequest__CAPA_Required__c   ) || record.compliancequest__Finding_Type__c == 'Direct'  || record.compliancequest__Finding_Type__c == 'Indirect'  || record.compliancequest__Finding_Type__c == 'Repeat' "}},"compliancequest__CAPA_Required__c":{"required":{"fields":["compliancequest__Finding_Type__c"],"filter":"record.compliancequest__Finding_Type__c == 'Direct'  || record.compliancequest__Finding_Type__c == 'Indirect'  || record.compliancequest__Finding_Type__c == 'Repeat' "}}};
const FORMULA_FIELDS = {};

export default class cquiFlexFindingAuditNewBoth  extends cquiFindingAuditCreate {
    ...
    get v_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C() {
        return this.getValueFor(FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C.fieldApiName);
    }
    get f_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C.fieldApiName] : {};
        return val;
    }

    get d_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C() {
        return lookupDisplayFields[FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_COMPLIANCEQUEST__SQX_REGULATORY_REQUIREMENT__C.fieldApiName].fieldApiName);
    }
    ...
    get v_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C() {
        return this.getValueFor(FIELD_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C.fieldApiName);
    }
    get f_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C() {
        let val=this.fieldsInfo ? this.fieldsInfo[FIELD_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C.fieldApiName] : {};
        return val;
    }

    get d_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C() {
        return lookupDisplayFields[FIELD_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C.fieldApiName] && this.getValueFor(lookupDisplayFields[FIELD_COMPLIANCEQUEST__TRACK_EXTERNAL_RESPONSE__C.fieldApiName].fieldApiName);
    }
