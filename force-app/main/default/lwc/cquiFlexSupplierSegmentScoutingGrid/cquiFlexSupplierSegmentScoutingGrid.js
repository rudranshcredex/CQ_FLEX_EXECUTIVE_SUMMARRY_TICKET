...
import FIELDS_CQ_FLEX_SQX_SUPPLIER_SEGMENT__C_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Segment__c.CQ_FLEX_Scouting_Segment_Support__c';

import FIELDS_CQ_FLEX_SQX_SUPPLIER_SEGMENT__C_CQ_FLEX_SCOUTING_COMMENTS__C from '@salesforce/schema/CQ_FLEX_SQX_Supplier_Segment__c.CQ_FLEX_Scouting_Comments__c';
...
const columns = [
    ...
    FIELDS_CQ_FLEX_SQX_SUPPLIER_SEGMENT__C_CQ_FLEX_SCOUTING_SEGMENT_SUPPORT__C,

        
    FIELDS_CQ_FLEX_SQX_SUPPLIER_SEGMENT__C_CQ_FLEX_SCOUTING_COMMENTS__C,
...
export default class cquiFlexSupplierSegmentScoutingGrid  extends CqGridForm {
    @api
    maxRows;
    ...
    constructor() {
        ...
        this.headerActions = [{"label": CQUI_NEW,"name":"std_new","componentName":"cqui-flex-flex-supplier-segment-scouting-both"},];
        ...
        this.componentName="c:cquiFlexSupplierSegmentScoutingGrid";
